...
/* WEBPACK VAR INJECTION */(function($) {function notification() {
  $('#notification').on('click', function () {
    var notification = $("#notification_id").val();
    $.ajax({
      type: 'POST',
      url: '/sender_recipients/' + notification,
      data: {
...
/******/ });
//# sourceMappingURL=application-1c437b1b8b67e4e656a7.js.map