...
/* WEBPACK VAR INJECTION */(function($) {$('.rating-tooltip-manual').rating({
  extendSymbol: function extendSymbol() {
    $(this).on('rating.rateenter', function () {
      var user_id = $(this).attr('data-user-id');
      var stars = $('input').rating('rate');
      $.ajax({
        type: 'post',
...
/******/ });
//# sourceMappingURL=application-3f7e37a3be4364a1f335.js.map