...
__webpack_require__(/*! packs/star-rating.min.js */ "./app/javascript/packs/star-rating.min.js"); // Uncomment to copy all static images under ../images to the output folder and reference
...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
  $("#rated").rating().on("rating:change", function (event, value, caption) {
...
/***/ "./app/javascript/packs/star-rating.min.js":
/*!*************************************************!*\
  !*** ./app/javascript/packs/star-rating.min.js ***!
  \*************************************************/
/*! no static exports found */
...
!function (e) {
  ...
  t = {
    ...
    DEFAULT_MAX: 5,
    DEFAULT_STEP: .5,
    isEmpty: function isEmpty(t, a) {
      return null === t || void 0 === t || 0 === t.length || a && "" === e.trim(t);
    },
    getCss: function getCss(e, t) {
      return e ? " " + t : "";
    },
    addCss: function addCss(e, t) {
      e.removeClass(t).addClass(t);
    },
    getDecimalPlaces: function getDecimalPlaces(e) {
      var t = ("" + e).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/);
      return t ? Math.max(0, (t[1] ? t[1].length : 0) - (t[2] ? +t[2] : 0)) : 0;
    },
    applyPrecision: function applyPrecision(e, t) {
      return parseFloat(e.toFixed(t));
    },
    handler: function handler(e, a, n, i, r) {
      var l = r ? a : a.split(" ").join(t.NAMESPACE + " ") + t.NAMESPACE;
      i || e.off(l), e.on(l, n);
    }
  }, a = function a(t, _a) {
    var n = this;
    n.$element = e(t), n._init(_a);
  }, a.prototype = {
    constructor: a,
    _parseAttr: function _parseAttr(e, a) {
      var n,
          i,
          r,
          l,
    ...
    _setDefault: function _setDefault(e, a) {
      var n = this;
      t.isEmpty(n[e]) && (n[e] = a);
    },
    ...
    _trigChange: function _trigChange(e) {
      var t = this;
    ...
    _initEvents: function _initEvents() {
      ...
      e.events = {
        ...
        _noMouseAction: function _noMouseAction(t) {
          return !e.hoverEnabled || e.inactive || t && t.isDefaultPrevented();
        },
        initTouch: function initTouch(a) {
          var n,
              i,
              r,
              l,
        ...
        starClick: function starClick(t) {
          var a, n;
        ...
        clearClick: function clearClick(t) {
          e.events._listenClick(t, function () {
            e.inactive || (e.clear(), e.clearClicked = !0);
          });
        },
        starMouseMove: function starMouseMove(t) {
          var a, n;
        ...
        clearMouseLeave: function clearMouseLeave(t) {
          var a;
...
/******/ });
//# sourceMappingURL=application-8a62c5284c19b657c057.js.map