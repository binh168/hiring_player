...
/* WEBPACK VAR INJECTION */(function($) {$('#recharge_money').keypress(function (e) {
  if (e.which == 13) {
    $('#formRecharge > form').submit();
  }
}).done(function () {
  $('#recharge > span').reload();
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery/src/jquery */ "./node_modules/jquery/src/jquery.js")))
...
/******/ });
//# sourceMappingURL=application-af41de92c0c1d74b804d.js.map