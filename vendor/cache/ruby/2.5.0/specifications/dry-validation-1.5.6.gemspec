# -*- encoding: utf-8 -*-
# stub: dry-validation 1.5.6 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<dry-container>.freeze, [">= 0.7.1", "~> 0.7"])
      ...
      s.add_runtime_dependency(%q<dry-schema>.freeze, [">= 1.5.2", "~> 1.5"])
      s.add_development_dependency(%q<bundler>.freeze, [">= 0"])
      s.add_development_dependency(%q<rake>.freeze, [">= 0"])
      s.add_development_dependency(%q<rspec>.freeze, [">= 0"])
    else
      s.add_dependency(%q<concurrent-ruby>.freeze, ["~> 1.0"])
      s.add_dependency(%q<dry-container>.freeze, [">= 0.7.1", "~> 0.7"])
      ...
      s.add_dependency(%q<dry-schema>.freeze, [">= 1.5.2", "~> 1.5"])
